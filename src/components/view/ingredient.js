...
class Ingredient extends Component{ 
    deleteIngredient=()=>{
        const id=this.props.info.idIngredient;
    ...
    render(){
        const {idIngredient,name,img} = this.props.info;
        return(
            <li className="list-group-item" id={idIngredient}>
                <div className="row justify-content-between align-items-center">
                    ...
                    <div className="col-md-4 d-flex justify-content-end acciones">
                        <Link to={`/admin/edit/ingredient/${idIngredient}`} className="btn btn-success mr-2">Edit</Link>
