...
class Dessert extends Component{ 
    deleteDessert=()=>{
        const id=this.props.info.idDessert;
    ...
    render(){
        const {idDessert,name,price,picture} = this.props.info;
        return(
            <li className="list-group-item" id={idDessert}>
                <div className="row justify-content-between align-items-center">
                    ...
                    <div className="col-md-4 d-flex justify-content-end acciones">
                        <Link to={`/admin/edit/dessert/${idDessert}`} className="btn btn-success mr-2">Edit</Link>
