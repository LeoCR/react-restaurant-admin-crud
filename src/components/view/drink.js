...
class Drink extends Component{ 
    deleteDrink=()=>{
        const id=this.props.info.idDrink;
    ...
    render(){
        const {idDrink,name,price,picture} = this.props.info;
        return(
            <li className="list-group-item" id={idDrink}>
                <div className="row justify-content-between align-items-center">
                    ...
                    <div className="col-md-4 d-flex justify-content-end acciones">
                        <Link to={`/admin/edit/drink/${idDrink}`} className="btn btn-success mr-2">Edit</Link>
